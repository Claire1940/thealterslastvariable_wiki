...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.thealterslastvariable.wiki'
  const path = '/about'
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: 'The Alters Last Variable Wiki',
      title: 'About The Alters Last Variable Wiki',
      description: 'Learn about our mission to provide the best The Alters: Last Variable game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'The Alters Last Variable Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About The Alters Last Variable Wiki',
      description: 'Learn about our mission to provide the best The Alters: Last Variable game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About The Alters Last Variable Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for The Alters: Last Variable
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              ...
              The Alters Last Variable Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower The Alters: Last Variable players with accurate, up-to-date information
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Alters Last Variable Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Alters Last Variable Wiki is maintained by a dedicated team of passionate gamers and developers who love
              The Alters: Last Variable as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of The Alters: Last Variable mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>The Alters Last Variable Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of The Alters: Last Variable or any official entities.
            </p>
            <p>
            ...
            <p>
              The Alters Last Variable Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@thealterslastvariable.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@thealterslastvariable.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@thealterslastvariable.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@thealterslastvariable.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@thealterslastvariable.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@thealterslastvariable.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@thealterslastvariable.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@thealterslastvariable.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and The Alters: Last Variable news.
